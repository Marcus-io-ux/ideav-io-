  ...
  return (
    <section className="py-24 bg-gradient-to-br from-background to-accent">
      <div className="container mx-auto px-4">
        ...
        {/* Mission Statement */}
        <p className="text-xl text-foreground/80 text-center max-w-3xl mx-auto mb-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {coreValues.map((value) => (
            <div
              key={value.title}
              className="bg-background/50 backdrop-blur-sm p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-accent"
            >
        ...
        {/* Origin Story */}
        <div className="bg-background/70 backdrop-blur-sm rounded-2xl p-8 mb-16 max-w-4xl mx-auto border border-accent">
          <h3 className="text-2xl font-semibold mb-4 text-center text-foreground">Our Story</h3>
